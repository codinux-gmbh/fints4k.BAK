...
@XmlType(name = "SecurityIdentification4Choice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "isin",
    "prtry"
})
public class SecurityIdentification4Choice {

    @XmlElement(name = "ISIN", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
