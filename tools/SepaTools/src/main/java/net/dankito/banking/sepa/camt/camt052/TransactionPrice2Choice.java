...
@XmlType(name = "TransactionPrice2Choice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "dealPric",
    "prtry"
})
public class TransactionPrice2Choice {

    @XmlElement(name = "DealPric", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
