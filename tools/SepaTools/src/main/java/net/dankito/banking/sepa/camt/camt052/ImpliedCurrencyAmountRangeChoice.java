...
@XmlType(name = "ImpliedCurrencyAmountRangeChoice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "frAmt",
    "toAmt",
    "frToAmt",
    "eqAmt",
...
public class ImpliedCurrencyAmountRangeChoice {
    ...
    @XmlElement(name = "FrAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected AmountRangeBoundary1 frAmt;
    @XmlElement(name = "ToAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected AmountRangeBoundary1 toAmt;
    @XmlElement(name = "FrToAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected FromToAmountRange frToAmt;
    @XmlElement(name = "EQAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected BigDecimal eqAmt;
    @XmlElement(name = "NEQAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
