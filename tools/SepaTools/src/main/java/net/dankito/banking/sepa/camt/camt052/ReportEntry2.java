...
@XmlType(name = "ReportEntry2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "ntryRef",
    "amt",
    "cdtDbtInd",
    "rvslInd",
...
public class ReportEntry2 {
    ...
    @XmlElement(name = "NtryRef", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    ...
    @XmlElement(name = "RvslInd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected Boolean rvslInd;
    @XmlElement(name = "Sts", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", required = true)
    @XmlSchemaType(name = "string")
    protected EntryStatus2Code sts;
    @XmlElement(name = "BookgDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected DateAndDateTimeChoice bookgDt;
    @XmlElement(name = "ValDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected DateAndDateTimeChoice valDt;
    @XmlElement(name = "AcctSvcrRef", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    ...
    @XmlElement(name = "ComssnWvrInd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected Boolean comssnWvrInd;
    @XmlElement(name = "AddtlInfInd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    ...
    @XmlElement(name = "TechInptChanl", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    ...
    @XmlElement(name = "NtryDtls", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected List<EntryDetails1> ntryDtls;
    @XmlElement(name = "AddtlNtryInf", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
