...
@XmlType(name = "TaxAuthorisation1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "titl",
    "nm"
})
public class TaxAuthorisation1 {

    @XmlElement(name = "Titl", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
