...
@XmlType(name = "TaxPeriod1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "yr",
    "tp",
    "frToDt"
})
public class TaxPeriod1 {
    ...
    @XmlElement(name = "Yr", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
