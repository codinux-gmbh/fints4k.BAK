...
@XmlType(name = "MessageIdentification2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "msgNmId",
    "msgId"
})
public class MessageIdentification2 {

    @XmlElement(name = "MsgNmId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
