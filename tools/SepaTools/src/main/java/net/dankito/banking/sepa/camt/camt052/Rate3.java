...
@XmlType(name = "Rate3", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "tp",
    "vldtyRg"
})
public class Rate3 {
    ...
    @XmlElement(name = "VldtyRg", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
