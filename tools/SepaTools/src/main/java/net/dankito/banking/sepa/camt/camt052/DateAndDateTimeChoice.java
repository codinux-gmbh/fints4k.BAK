...
@XmlType(name = "DateAndDateTimeChoice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "dt",
    "dtTm"
})
public class DateAndDateTimeChoice {
    ...
    @XmlElement(name = "DtTm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
