...
@XmlType(name = "RateType4Choice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "pctg",
    "othr"
})
public class RateType4Choice {

    @XmlElement(name = "Pctg", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
