...
@XmlType(name = "EntryDetails1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "btch",
    "txDtls"
})
public class EntryDetails1 {

    @XmlElement(name = "Btch", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected BatchInformation2 btch;
    @XmlElement(name = "TxDtls", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
