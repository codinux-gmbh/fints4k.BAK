...
@XmlType(name = "CashAccount20", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "id",
    "tp",
    "ccy",
    "nm",
...
public class CashAccount20 {
    ...
    @XmlElement(name = "Ccy", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected String ccy;
    @XmlElement(name = "Nm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected String nm;
    @XmlElement(name = "Ownr", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected PartyIdentification32 ownr;
    @XmlElement(name = "Svcr", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
