...
@XmlType(name = "TransactionAgents2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "dbtrAgt",
    "cdtrAgt",
    "intrmyAgt1",
    "intrmyAgt2",
...
public class TransactionAgents2 {
    ...
    @XmlElement(name = "DbtrAgt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected BranchAndFinancialInstitutionIdentification4 dbtrAgt;
    @XmlElement(name = "CdtrAgt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected BranchAndFinancialInstitutionIdentification4 cdtrAgt;
    @XmlElement(name = "IntrmyAgt1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected BranchAndFinancialInstitutionIdentification4 intrmyAgt1;
    @XmlElement(name = "IntrmyAgt2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected BranchAndFinancialInstitutionIdentification4 intrmyAgt2;
    @XmlElement(name = "IntrmyAgt3", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected BranchAndFinancialInstitutionIdentification4 intrmyAgt3;
    @XmlElement(name = "RcvgAgt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected BranchAndFinancialInstitutionIdentification4 rcvgAgt;
    @XmlElement(name = "DlvrgAgt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected BranchAndFinancialInstitutionIdentification4 dlvrgAgt;
    @XmlElement(name = "IssgAgt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected BranchAndFinancialInstitutionIdentification4 issgAgt;
    @XmlElement(name = "SttlmPlc", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
