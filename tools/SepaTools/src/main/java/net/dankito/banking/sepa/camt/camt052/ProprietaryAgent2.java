...
@XmlType(name = "ProprietaryAgent2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "tp",
    "agt"
})
public class ProprietaryAgent2 {
    ...
    protected String tp;
    @XmlElement(name = "Agt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", required = true)
