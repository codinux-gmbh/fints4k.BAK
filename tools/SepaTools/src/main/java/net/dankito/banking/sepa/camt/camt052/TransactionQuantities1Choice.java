...
@XmlType(name = "TransactionQuantities1Choice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "qty",
    "prtry"
})
public class TransactionQuantities1Choice {

    @XmlElement(name = "Qty", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
