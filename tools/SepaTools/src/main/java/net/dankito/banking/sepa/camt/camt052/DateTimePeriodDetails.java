...
@XmlType(name = "DateTimePeriodDetails", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "frDtTm",
    "toDtTm"
})
public class DateTimePeriodDetails {

    @XmlElement(name = "FrDtTm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", required = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar frDtTm;
    @XmlElement(name = "ToDtTm", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", required = true)
    @XmlSchemaType(name = "dateTime")
