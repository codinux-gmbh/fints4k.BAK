...
@XmlType(name = "DatePeriodDetails", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "frDt",
    "toDt"
})
public class DatePeriodDetails {

    @XmlElement(name = "FrDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar frDt;
    @XmlElement(name = "ToDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", required = true)
    @XmlSchemaType(name = "date")
