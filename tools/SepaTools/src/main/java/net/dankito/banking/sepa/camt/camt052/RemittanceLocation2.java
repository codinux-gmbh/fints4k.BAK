...
@XmlType(name = "RemittanceLocation2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "rmtId",
    "rmtLctnMtd",
    "rmtLctnElctrncAdr",
    "rmtLctnPstlAdr"
...
public class RemittanceLocation2 {
    ...
    @XmlElement(name = "RmtId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected String rmtId;
    @XmlElement(name = "RmtLctnMtd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    @XmlSchemaType(name = "string")
    protected RemittanceLocationMethod2Code rmtLctnMtd;
    @XmlElement(name = "RmtLctnElctrncAdr", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected String rmtLctnElctrncAdr;
    @XmlElement(name = "RmtLctnPstlAdr", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
