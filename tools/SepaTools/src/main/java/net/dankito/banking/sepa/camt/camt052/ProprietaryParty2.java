...
@XmlType(name = "ProprietaryParty2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "tp",
    "pty"
})
public class ProprietaryParty2 {
    ...
    protected String tp;
    @XmlElement(name = "Pty", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", required = true)
