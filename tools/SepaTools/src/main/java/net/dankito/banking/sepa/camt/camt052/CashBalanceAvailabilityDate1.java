...
@XmlType(name = "CashBalanceAvailabilityDate1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "nbOfDays",
    "actlDt"
})
public class CashBalanceAvailabilityDate1 {

    @XmlElement(name = "NbOfDays", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected String nbOfDays;
    @XmlElement(name = "ActlDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
