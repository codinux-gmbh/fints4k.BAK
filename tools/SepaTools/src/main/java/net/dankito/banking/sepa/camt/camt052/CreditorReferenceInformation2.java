...
@XmlType(name = "CreditorReferenceInformation2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "tp",
    "ref"
})
public class CreditorReferenceInformation2 {
    ...
    @XmlElement(name = "Ref", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
