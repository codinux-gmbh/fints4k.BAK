...
@XmlType(name = "OrganisationIdentification4", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "bicOrBEI",
    "othr"
})
public class OrganisationIdentification4 {

    @XmlElement(name = "BICOrBEI", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
