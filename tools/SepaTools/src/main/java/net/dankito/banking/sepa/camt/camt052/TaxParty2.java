...
@XmlType(name = "TaxParty2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "taxId",
    "regnId",
    "taxTp",
    "authstn"
...
public class TaxParty2 {
    ...
    @XmlElement(name = "TaxId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected String taxId;
    @XmlElement(name = "RegnId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected String regnId;
    @XmlElement(name = "TaxTp", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    protected String taxTp;
    @XmlElement(name = "Authstn", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
