...
@XmlType(name = "TaxCharges2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "id",
    "rate",
    "amt"
})
public class TaxCharges2 {
    ...
    @XmlElement(name = "Amt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
