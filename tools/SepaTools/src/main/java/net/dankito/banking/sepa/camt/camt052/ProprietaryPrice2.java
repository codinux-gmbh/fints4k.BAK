...
@XmlType(name = "ProprietaryPrice2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "tp",
    "pric"
})
public class ProprietaryPrice2 {
    ...
    protected String tp;
    @XmlElement(name = "Pric", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", required = true)
