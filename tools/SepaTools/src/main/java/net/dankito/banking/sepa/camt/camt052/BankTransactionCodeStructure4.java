...
@XmlType(name = "BankTransactionCodeStructure4", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "domn",
    "prtry"
})
public class BankTransactionCodeStructure4 {

    @XmlElement(name = "Domn", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
