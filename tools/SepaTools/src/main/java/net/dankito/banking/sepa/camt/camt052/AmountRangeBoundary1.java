...
@XmlType(name = "AmountRangeBoundary1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "bdryAmt",
    "incl"
})
public class AmountRangeBoundary1 {

    @XmlElement(name = "BdryAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", required = true)
    protected BigDecimal bdryAmt;
    @XmlElement(name = "Incl", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
