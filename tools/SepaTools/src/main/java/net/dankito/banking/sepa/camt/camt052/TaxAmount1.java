...
@XmlType(name = "TaxAmount1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "rate",
    "taxblBaseAmt",
    "ttlAmt",
    "dtls"
...
public class TaxAmount1 {
    ...
    @XmlElement(name = "TaxblBaseAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
    ...
    @XmlElement(name = "Dtls", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
