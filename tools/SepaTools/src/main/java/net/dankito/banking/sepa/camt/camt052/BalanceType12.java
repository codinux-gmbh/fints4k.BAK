...
@XmlType(name = "BalanceType12", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02", propOrder = {
    "cdOrPrtry",
    "subTp"
})
public class BalanceType12 {
    ...
    @XmlElement(name = "SubTp", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.052.001.02")
